...
export default function TOC() {
  ...
  return (
    <Nav variant="pills" id="wd-toc">
      ...
      <Nav.Item> <Nav.Link href="https://github.com/varshinisun/kambaz-react-web-app" target="_blank"> My GitHub </Nav.Link> </Nav.Item>
    </Nav>
  );
}
...
//https://github.com/varshinisun/kambaz-react-web-app